...
function topmenu_change() {
    ...
    $("#selUser1").select2();
    if (comp_value == "dinucleic" || comp_value == "trinucleic") {
...
function populate_analysis_menu(type) {
    ...
    if (type == "dinucleic") {
        options += "<option value='none_"+type+"' style='color:black' selected>Select a dinucleic analysis</option>";
        options += "<option value='count_dinucleic_box_plots'>Count Dinucleic box plot</option>";
        options += "<option value='frequency_dinucleic_box_plots'>Frequency Dinucleic box plot</option>";
    }
    else if (type == "trinucleic") {
        options += "<option value='none_"+type+"' style='color:black' selected>Select a tri nucleic analysis</option>";
        options += "<option value='count_tri_nucleic_box_plots'>Count Tri nucleic box plot</option>";
        options += "<option value='frequency_tri_nucleic_box_plots'>Frequency Tri nucleic box plot</option>";
    }
    else {
        options += "<option value='none_"+type+"' style='color:black' selected>Analyses are for dinucleic or tri nucleic compositions</option>";
    }
    options += "</optgroup>";
    return options;
}