...
function populate_analysis_menu(count, top_vals) {
    ...
    if (top_vals.includes("Tzi8") || top_vals.includes("Sorghum_v3_1_annotation")) {
        options +="<optgroup label='No analyses are available for the Sorghum v3 Gene ID and Tzi8 Gene ID.'></optgroup>";
        return options;
    }
